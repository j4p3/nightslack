...
remote_repo = 'https://raw.githubusercontent.com/j4p3/slack-themes/master/dark-slate.css'
...
target_css_file =  static_path + 'midnight-blue.css'
...
document.addEventListener('DOMContentLoaded', function() {
  $.ajax({
    url: 'https://raw.githubusercontent.com/j4p3/slack-themes/master/dark-slate.css',
